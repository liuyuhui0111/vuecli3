...
const SSO_URL = 'http://wxkf.5ifapiao.com';
...
export function loginout() {
    ...
    // const redirect_uri = encodeURIComponent(replaceCode());
    // const url = '/authentication/h5/logout';
    // return get(url, {redirect_uri} || {});
}
...
export function getNewCourseList(params) {
    // 首页新鲜出炉列表
    const url = `${BASE_URL}/course-web/getNewCourseList`;
    return post(url, params || {});
}
export function getGroomCourseList(params) {
    // 首页推荐课程列表
    const url = `${BASE_URL}/course-web/getGroomCourseList`;
    return post(url, params || {});
}
...
export function getCourseList(params) {
    ...
    const url = `${BASE_URL}/course-web/getCourseList`;
    return post(url, params || {});
}
...
export function getCourse(params) {
    // 根据id查询线上课
    const url = `${BASE_URL}/course-web/getCourse`;
    return post(url, params || {});
}
...
export function getVideoUrl(params) {
    // 获取视频播放地址
    const url = `${BASE_URL}/course-web/getVideoUrl`;
    return post(url, params || {});
}
...
export function locations(params) {
    // 获取地区接口http://wxkf.5ifapiao.com/api-gateway/aosp-customer/customer/dictionary/locations
    const url = `${BASE_URL}/api-gateway/aosp-customer/customer/dictionary/locations`;
...
export function pay(params) {
    // 统一下单
    const url = `${BASE_URL}/orderId/pay`;
    return post(url, params || {});
}
